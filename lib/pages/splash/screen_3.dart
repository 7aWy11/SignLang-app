...
class _SplashScreenThreeState extends State<SplashScreenThree> with SingleTickerProviderStateMixin {
  ...
  void _navigateToNextScreen() {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => SplashScreenFour(),
